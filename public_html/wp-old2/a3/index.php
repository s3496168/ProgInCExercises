                    ...
                    <section class="nowShowing">
                        <div class="first">
                            ...
                            <div class="inner-grid-container large">
                                ...
                                <div class='card3D'>
                                    <div><img src="../../media/barbie.jpg" alt="Barbie movie poster" class="poster">
...
<https://www.imdb.com/title/tt1517268>
                                ...
                                <div class='card3D'>
                                    <div><img src="../../media/Teenage_Mutant_Ninja_Turtles_-_Mutant_Mayhem.jpg" alt="Teenage Mutant Ninja Turtles: Mutant Mayhem movie poster" class="poster">
...
<https://www.imdb.com/title/tt8589698>
                                ...
                                <div class='card3D'>
                                    <div><img src="../../media/indianajones_dialofdestiny.jpg" alt="Indiana Jones and the Dial of Destiny movie poster" class="poster">
...
<https://www.imdb.com/title/tt1462764 >
                                ...
                                <div class='card3D'>
                                    <div><img src="../../media/Oppenheimer_(film).jpg" alt="Oppenheimer movie poster" class="poster">
                                        <div class="tANDr Space extra"><strong class="bitMore tinyLeft extra">Oppenheimer</strong><br><strong class="littleBitMore extra">Rated: R</strong></div>
                                    </div>
                                    <div>
                                        <div class="descriptive littleSpace"><strong class="bitMore">Synopsis:</strong>
       ...
       // Attach a click event listener to button 2
        document.getElementById('BarbieBtn').addEventListener('click', function() {
           ...
           // window.location.href = 'booking.php?RMC';
             window.location.href = 'booking.php?code=RMC';
        });
        // Attach a click event listener to button 2
