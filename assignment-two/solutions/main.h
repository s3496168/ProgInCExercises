...
struct editor_system
{
        ...
        const char* file;
        /* linked list holding all the lines that have been loaded from the
         * current
         * file
         */
        ...
        /**
         * boolean variable that stores whether the current file that is loaded
         *has
         * been modified since it was last saved or loaded. This is needed both
         *for
         * the discard message when exiting and for rejecting requests to load a
         *new
